  ...
  return (
    ...
    <div>
      ...
      <div className='bot-nav'>
        ...
        <div className="bot-nav-left-side">

          <div className="fast-links">
            <p className="nav-item-bot">Fast Links</p>
            ...
            <Link to="/challenges" className="nav-item-bot">Challenges</Link>
          </div>

          <div className="follow-us">
            <p className="nav-item-bot">Follow us</p>
      ...
      <nav className='bot-nav'>
        ...
        <div className="bot-nav-right-side">
